...
- __What we Learnt:__ React: passing props up hack by using inline functions, app desing and structural engineering. Node: Hosting a intermediary API. I just added a new theme using a useState hook, the state is saved as a boolean in local storage, as such the them should be stored for you upon refresh, if not, the app will automaticallty match the defualt theme of your CPU. 
<br>
